...
- **Native Fluss log-table source — done** (was ticket 36). Fluss (columnar streaming storage) is the
  ...
  Method + full numbers in `docs/benchmarks.md` (2026-07-06 watermarked run: 19 of 23 queries
  measured — the windowed family included, q11 peaking at 4.17x; only q4/q9/q12/q21 skip, each
  for a recorded no-deterministic-finish-line reason). Watermarked tables route natively (the
  ...
  partition-removal-plumbing alignment cleanup.
